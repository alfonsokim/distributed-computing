...
public class ChatServer extends UnicastRemoteObject implements IChatServer {
	...
	public synchronized void login(String name, IChatClient nc)
	...
	public static void main(String[] args) {
		String helloPath = ChatServer.class.getResource("ChatServer.class").getFile();
		helloPath = helloPath.replace("/example/chat/ChatServer.class", "");
